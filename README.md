# Crucial Info
The below readme is the workflow details that I am making use of. I just copied the entire readme file from that repo. Check th elink to see the actual repo which will havemore details you may want to read. I aslo added 1 more repo. We can all finialzie waht we want to use when its time for that.

FYI, the entire code base took CLaude Code Max Opus 4.5 around 4-5 hours to complete. If I had more calrified details, would have been a much better output. Check the Prompt.md to see what was my prompt.
...
[Link 1](https://github.com/wshobson/agents/blob/main/docs/agents.md)
[Link 2](https://github.com/zhsama/claude-sub-agent) <- This is what I am using
